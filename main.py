...
class GraphicalInterface(QMainWindow):
    ...
    def start_program(self) -> None:
        ...
        if self.is_fill(name, quantity):
            ...
            # self.data = [['Apple\nСмартфон Apple iPhone 15 Pro 1TB MTQJ3 White Titanium', '183847089', 'Нет оценок', '', '260 749 ₽', '234 674 ₽'], ['Apple\nСмартфон Apple iPhone 15 Pro 256GB MTV63ZD/A Blue Titanium', '183849503', 'Нет оценок', '', '179 869 ₽', '161 882 ₽'], ['Apple\niPhone 14 Pro 1TB',
            #                                                                                                                                                                                                                                                                          '152685689', '1', '1 оценка', '179 990 ₽', '152 991 ₽'], ['Apple\nСмартфон Apple iPhone 11 128 ГБ черный Восстановленный', '182865189', '4.5', '36 оценок', '46 017 ₽', '28 990 ₽'], ['Apple\niPhone 15 Pro 128GB', '177120755', '5', '5 оценок', '189 990 ₽', '116 273 ₽']]
            self.workerThread = FileWritingThread(self.data, DEFAULT_PATH)
            # self.workerThread.finished.connect(self.onFileWritingFinished)
    ...
    # def onFileWritingFinished(self):
    #     QMessageBox.information(
    #         self, 'Успешно', 'Данные успешно сохранены в json')
    ...
    def save_data_to_excel(self):
        try:
            ...
            QMessageBox.warning(
                ...
                Данные будут сохранены в директорию по умолчанию')
